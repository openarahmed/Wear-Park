    ...
    return (
        <div className="p-6 max-w-2xl mx-auto">
            ...
            <form onSubmit={handleCreateProduct} className="space-y-4">
                ...
                <Input name="base" value={formData.base} onChange={handleChange} placeholder="Base Collection" />
                <Input name="price" value={formData.price} onChange={handleChange} placeholder="Price" />
                <Input name="rating" type="number" step="0.1" min="0" max="5" value={formData.rating} onChange={handleChange} placeholder="Rating" />
